...
const TODO_REPLACE_INSTAGRAM_URL = "https://instagram.com/shadow____.18";
const TODO_REPLACE_X_URL = "https://x.com/shadow___18";
...
const XIcon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
    <path d="M18.9 2H22l-6.77 7.74L23.2 22h-6.24l-4.89-6.39L6.48 22H3.37l7.24-8.28L2.8 2h6.4l4.42 5.84L18.9 2Zm-1.1 17.9h1.73L8.28 4H6.42L17.8 19.9Z" />
  </svg>
);
      ...
      <div className="relative z-20 w-full max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16 flex flex-col lg:flex-row gap-16 lg:gap-24 items-start justify-between mt-8">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-start text-left">
          ...
          <div className="flex items-center justify-start gap-4 mb-10 w-full">
            ...
            <a
              href={TODO_REPLACE_INSTAGRAM_URL}
              target="_blank"
              rel="noopener noreferrer"
              className="w-12 h-12 rounded-full border border-white/10 bg-white/3 flex items-center justify-center text-white/40 hover:text-primary hover:border-primary/30 hover:bg-white/6 transition-all duration-300 group"
              aria-label="Instagram (TODO_REPLACE)"
            >
              <InstagramIcon className="w-5 h-5 group-hover:scale-110 transition-transform duration-300" />
            </a>
            <a
              href={TODO_REPLACE_X_URL}
              target="_blank"
              rel="noopener noreferrer"
              className="w-12 h-12 rounded-full border border-white/10 bg-white/3 flex items-center justify-center text-white/40 hover:text-primary hover:border-primary/30 hover:bg-white/6 transition-all duration-300 group"
              aria-label="X (TODO_REPLACE)"
            >
              <XIcon className="w-5 h-5 group-hover:scale-110 transition-transform duration-300" />
            </a>
          </div>
          ...
          <div className="flex flex-wrap gap-x-8 gap-y-4 text-xs md:text-sm uppercase tracking-widest font-semibold text-white/45 w-full">
            ...
            <a href={TODO_REPLACE_INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="hover:text-white flex items-center gap-1 group transition-colors duration-300">
              Instagram <ArrowUpRight className="w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </a>
            <a href={TODO_REPLACE_X_URL} target="_blank" rel="noopener noreferrer" className="hover:text-white flex items-center gap-1 group transition-colors duration-300">
              X <ArrowUpRight className="w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </a>
          </div>
        </div>
